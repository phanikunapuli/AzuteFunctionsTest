    ...
    public static class TestSqlConnection
    {
        ...
        public static async Task<HttpResponseMessage> Run([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)]HttpRequestMessage req, TraceWriter log)
        {
            ...
            return name == null
                ...
                : req.CreateResponse(HttpStatusCode.OK, "Hello " + namefromdatabase +  name);
            //var str = System.Configuration.ConfigurationManager.ConnectionStrings["SQLConnectionString"].ConnectionString;
            ////SqlConnectionStringBuilder builder = new SqlConnectionStringBuilder();
            ////builder.DataSource = "testazuresqlserverphani.database.windows.net";
            ////builder.UserID = "Phani";
            ////builder.Password = "Testazuresql8";
            ////builder.InitialCatalog = "TestAzureSQL";
